...
if (message.content.startsWith(prefix + 'help')) { /// This is The DMS Code Send The Help In DMS // Code By NotGucci
    let pages = [`**
        ***__<a:admin:600966449477058571>اوامر عامة<a:admin:600966449477058571>__***
**
...
**
   `,`
        ***__<a:musics:600966544553410560>موسيقى<a:musics:600966544553410560>__***
**
...
**
        ***__<a:colorss:600966754562342912>العاب متنوعة<a:colorss:600966754562342912>__***
 **       
...
client.on('message', msg => {
  ...
  let args = msg.content.split(" ").slice(1);
    ...
    if (textxt == "") {
        msg.delete().then
    msg.channel.send("***```<a:inf:600956061851058196>ضع عدد الرسائل التي تريد مسحها ??```***").then(m => m.delete(3000));
} else {
    msg.delete().then
    msg.delete().then
...
reaction2.on("collect", r => {
message.channel.send(`**<a:inf:600956061851058196>Chat deletion cancelled**`).then(m => m.delete(5000));
msg.delete();
})
})
}
...
.setFooter(message.author.username, message.author.avatarURL);
 ...
 client.on('message', message => {
    ...
    if (message.member.voiceChannel == null) return message.channel.send(`**الرجاء الدخول لروم صوتي**`)
     ...
     message.channel.send(`**<a:inf:600956061851058196>تم سحب جميع الأعضاء الي الروم الصوتي حقك.**`)
